...
The [Protest-Roundup-Run](https://github.com/MindPetal/protest-alerts/actions/workflows/protest-roundup-run.yaml) workflow runs weekly and posts a roundup of all currently open GAO protests for every tracked solicitation. It is not date bound and reuses the same secrets.
